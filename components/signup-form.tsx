...
export function SignupForm({
  ...
  return (
    <div className="fixed inset-0 flex h-screen w-screen items-center justify-center bg-background p-4 overflow-hidden">
      <div className={cn("w-full max-w-[400px] flex flex-col gap-3", className)} {...props}>
              ...
              <FieldGroup className="gap-3">
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field aria-invalid={fieldState.invalid} className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <input
                    ...
                    id="terms"
                    {...register("terms")}
                    className="h-4 w-4 rounded border-gray-300 accent-neutral-900"
                  />
                ...
                <div className="flex flex-col gap-3 mt-2">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <Button variant="outline" type="button" className="h-9 py-0">
        ...
        <FieldDescription className="px-6 text-center text-[11px] leading-tight text-muted-foreground">
          By clicking continue, you agree to our <a href="#" className="underline underline-offset-2">Terms of Service</a> and <a href="#" className="underline underline-offset-2">Privacy Policy</a>.
        </FieldDescription>
      </div>
    </div>
  )
